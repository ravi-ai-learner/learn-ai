    ...
    tile.innerHTML = `
	  <div style="display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 4px;">
	    <div style="display: flex; align-items: baseline; gap: 4px;">
	      <span style="font-size: 18px; font-weight: 600;">${streak.consistency}</span>
	      <span style="font-size: 12px;">%</span>
	      <span style="font-size: 12px; color: var(--text-muted);">Discipline</span>
	    </div>
	    <div style="font-size: 24px; margin-right: 3px;">${habit.name}</div>
	  </div>
	  ...
	  <div style="display: flex; justify-content: space-between; margin-top: 12px;">
	    <div style="flex: 1; display: flex; flex-direction: column; align-items: center;">
	      ...
	      <div style="font-size: 18px;"><b>${streak.current}</b> <span style="font-size: 12px;">days</span></div>
	    </div>
	    <div style="flex: 1; display: flex; flex-direction: column; align-items: center;">
	      <div style="font-size: 12px; color: var(--text-muted);">Longest Streak</div>
	      <div style="font-size: 18px;"><b>${streak.longest}</b> <span style="font-size: 12px;">days</span></div>
	    </div>
	  </div>
	`;
