...
const trackingStart = sortedFiles.length > 0 ? window.moment(sortedFiles[0].file.name, "YYYY-MM-DD") : null;
...
function renderToggleGroup(container) {
  ...
  monthlyLabel.textContent = "Monthly View";
  ...
  heatmapLabel.textContent = "Show Heatmap";
  ...
  datesLabel.textContent = "Hide Dates";
